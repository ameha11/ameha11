...
```{r}
Ebinat_kebeles<- hh_data %>% dplyr::select('Woreda', 'Kebele') %>% drop_na()%>%  dplyr::filter(Woreda=="Ebinat")%>% dplyr::group_by(Kebele) %>% dplyr::summarise(No_of_kebele= n())
...
```{r}
Dewat_kebeles<- hh_data %>% dplyr::select('Woreda', 'Kebele') %>% drop_na()%>%  dplyr::filter(Woreda=="Dewa Chefa")%>% dplyr::group_by(Kebele) %>% dplyr::summarise(No_of_kebele= n())
...
```{r}
Artuma_kebeles<- hh_data %>% dplyr::select('Woreda', 'Kebele') %>% drop_na()%>%  dplyr::filter(Woreda=="Artuma Fursi")%>% dplyr::group_by(Kebele) %>% dplyr::summarise(No_of_kebele= n())

Artuma_kebeles$Kebele<- factor(Ebinat_kebeles$Kebele, levels=Ebinat_kebeles[["Kebele"]])
...
```{r}
Libo_kebeles<- hh_data %>% dplyr::select('Woreda', 'Kebele') %>% drop_na()%>%  dplyr::filter(Woreda=="Libo Kemkem")%>% dplyr::group_by(Kebele) %>% dplyr::summarise(No_of_kebele= n())
