...
s2_5_1_plot <- s2_5_1_plot %>% layout(
  title = list(text = 'Number of PSNP transfers PWS and TDS HHs supposed to receive per year', x = 0.1),
  xaxis = list(title = ''),
  yaxis = list(title = 'Percent', ticksuffix = '%'),
  barmode = 'stack',
  showlegend = TRUE,
...
s2_5_2_plot <- s2_5_2_plot %>% layout(
  title = list(text = 'Number of PSNP transfers PDS HHs supposed to receive per year', x = 0.1),
  xaxis = list(title = ''),
  yaxis = list(title = 'Percent', ticksuffix = '%'),
  barmode = 'stack',
  showlegend = TRUE,
