...
```{r}
sup_name <- c("Asnake", "Addis", "Selamu", "Solomon", "Natnael", "Hiwot")
sup_emp <- c(Asnake_emp, Addis_emp, Selamu_emp, Solomon_emp, Natnael_emp, Hiwot_emp)
sup_pro <- c(Asnake_pro, Addis_pro, Selamu_pro, Solomon_pro, Natnael_pro, Hiwot_pro)
sup_cli <- c(Asnake_cli, Addis_cli, Selamu_cli, Solomon_cli, Natnael_cli, Hiwot_cli)
...
emp_zone_exp <- c(0,	0, 52.5, 52.5, 210, 105)
