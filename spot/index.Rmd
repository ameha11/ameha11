...
woreda_data<-read_dta("C:/Survey Spotcheck II/Data/Raw_data/PSNP_WOREDA_FINAL_OR/PSNP_WOREDA_FINAL_OR.dta")
...
#Kebele data
kebele_data<-read_dta("C:/Survey Spotcheck II/Data/Raw_data/PSNP_5_KEBELE_FINAL_OR/PSNP_5_KEBELE_FINAL_OR.dta")
...
#Household data
hh_data<-read_dta("C:/Survey Spotcheck II/Data/Raw_data/PSNP_5_HOUSEHOLD_FINAL_OR/PSNP_5_HOUSEHOLD_FINAL_OR.dta")
...
doc_p1<-read_dta("C:/Survey Spotcheck II/Data/Raw_data/PSNP_WOREDA_FINAL_OR/documents_1.dta")
...
record_k1<-read_dta("C:/Survey Spotcheck II/Data/Raw_data/PSNP_WOREDA_FINAL_OR/Record_Keeping_1.dta")
...
record_k2<-read_dta("C:/Survey Spotcheck II/Data/Raw_data/PSNP_WOREDA_FINAL_OR/Record_Keeping_1.dta")
...
```{r }
k_doc1<-read_dta("C:/Survey Spotcheck II/Data/Raw_data/PSNP_5_KEBELE_FINAL_OR/PSNP_available_doc.dta")
...
record_k2<-read_dta("C:/Survey Spotcheck II/Data/Raw_data/PSNP_5_KEBELE_FINAL_OR/records.dta")
record_k2 <- as_factor(record_k2) 
record_k2 <- droplevels(record_k2)
options(digits=1) 
